  ...
  const handleCreateSubmit = useCallback(
    async (data: UpdateSize) => {
      ...
      try {
        ...
        toast.success(`Продукт ${data.size} успішно створено!`);
        ...
        toast.error("Помилка створення розміру");
      }
    },
    [refetchSizes],
  ); // Додано залежності
